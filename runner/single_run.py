...
def run_single(config: dict, agent, crops: list, upgrades: list, watering_settings=None, fertilizer_config=None,
               seed=None, record_history: bool = False, world=None):
    ...
    for _ in range(config["days"]):
        ...
        engine.run_day(
            ...
            watering_settings or {}, fertilizer_config or {}, rng, world=world,
        )
        if record_history:
            history.append({
                "day": player.day,
                ...
                "inventory_lots": [
                    {"item_id": lot.item_id, "quantity": lot.quantity, "quality": lot.quality, "age": lot.age_days}
